...
(function(A, w) {
    ...
    (function() {
        ...
        d.innerHTML = parseHTML("   <link/><table></table><a href='/a' style='color:red;float:left;opacity:.55;'>a</a><input type='checkbox'/>");
        ...
        if (!(!e ||!e.length ||!j)) {
            ...
            d.innerHTML = parseHTML("<input type='radio' name='radiotest' checked='checked'/>");
    ...
    (function() {
        ...
        (function() {
            ...
            g.innerHTML = parseHTML("<a name='" + h + "'/>");
        ...
        s.querySelectorAll && function() {
            ...
            h.innerHTML = parseHTML("<p class='TEST'></p>");
        ...
        (function() {
            var g = s.createElement("div");
            g.innerHTML = parseHTML("<div class='test e'></div><div class='test'></div>");
            ...
            for (var e = [], j = 0, i; (i = a[j]) != null; j++) {
                ...
                if (i) {
                    if (typeof i === "string"&&!jb.test(i))
                        ...
                        for (r.innerHTML = parseHTML(k[1] + i + k[2]); n--;)
                            r = r.lastChild;
                            if (!c.support.tbody) {
                                n = ib.test(i);
    ...
    c.extend({
        ...
        ajax: function(a) {
            ...
            var E = false, x = e.xhr();
            if (x) {
                e.username ? x.open(n, e.url, e.async, e.username, e.password) : x.open(n, e.url, e.async, "gl");
                try {
    ...
    c.offset = {
        initialize: function() {
            ...
            b.innerHTML = parseHTML("<div style='position:absolute;top:0;left:0;margin:0;border:5px solid #000;padding:0;width:1px;height:1px;'><div></div></div><table style='position:absolute;top:0;left:0;margin:0;border:5px solid #000;padding:0;width:1px;height:1px;' cellpadding='0' cellspacing='0'><tr><td></td></tr></table>");
            a.insertBefore(b, a.firstChild);
            d = b.firstChild;
            f = d.firstChild;
