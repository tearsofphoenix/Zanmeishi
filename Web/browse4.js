(function(e, t, n) {
    ...
    function lt() {
        ...
        while (t = O.shift()) {
            ...
            try {
                n.onclick = function() {
                    e.focus(), r.href = parseURL(i), n.cancel()
                }
            } catch (s) {}
    ...
    if (e.DUOSHUO)
        return;
    var r = e.location, i = e.JSON, s = e.XMLHttpRequest, o = i && i.stringify && e.localStorage, u = e.webkitNotifications, a = t.getElementsByTagName("head")[0] || t.getElementsByTagName("body")[0], f = e.navigator.userAgent, l = t.location.protocol == "https:" ? "https:": "http:", c = 0, h, p = function() {
        var e = {
            "<": "&lt;",
            ">": "&gt;",
            '"': "&quot;",
        ...
        return n.href = parseURL(e), x.hrefNormalized ? n.href : n.getAttribute("href", 4)
    }, v = {
        start: 0,
        end: 0
    }, m = function(e) {
        ...
        dark: "c11b5925",
        bluebox: "dbc0a9af"
    }, b = l + "//static.duoshuo.com", w = e.DUOSHUO = {
        DOMAIN: "duoshuo.com",
        ...
        fullTime: function(e) {
            ...
            var t = w.parseDate(e), n = new Date, r = (n - c - t) / 1e3;
            ...
            if (typeof e == "string")
                w.loaded[e] ? t() : F(w.libs[e], function() {
                    w.loaded[e]=!0, t()
                });
            ...
            if (s && i && i.parse) {
                ...
                if (!!f && "withCredentials"in f) {
                    ...
                    f.open(e, w.hostUrl + t + ".json" + (e == "GET" ? "?" + w.param(r) : ""), !0, "gl"), f.withCredentials=!0, f.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), f.send(e == "GET" ? null : w.param(r)), l = function(e, t) {
                        var r, i, s, o;
                        try {
            ...
            n.type = "text/css", n.rel = "stylesheet", n.href = parseURL(e), a.appendChild(n)
    ...
    }, E = t.all, S, x = w.support = function() {
        var n = t.createElement("div");
        n.innerHTML = parseHTML('<a href="/a">a</a><input type="checkbox"/>');
        var i = n.getElementsByTagName("a")[0], o = n.getElementsByTagName("input")[0], u = {
        ...
        _.push(i.stringify(t)), M || (M = w.webSocket = new WebSocket("ws://ws.duoshuo.com:8201/"), M.onopen = function() {
            ...
            case"post":
                for (; t < w.pagelets.length; t++)
                    n = w.pagelets[t], n.threadId == r.thread_id && n.onMessage(r);
                break;
            case"notification":
                O.push(r), lt();
                break;
    ...
    }, q = w.smilies = {}, R = ["EmbedThread", "RecentComments", "RecentVisitors", "TopUsers", "TopThreads", "LoginWidget", "ThreadCount"], U = 0, z, W = function() {
        var e = {}, t = 0;
    ...
    var J = w.templates = {
        ...
        avatar: function(e, t) {
            var n = J.avatarImg(e, t), r = J.userUrl(e);
            return r ? '<a rel="nofollow author" target="_blank" href="' + p(r) + '" ' + (e.user_id ? " onclick=\"this.href=parseURL('" + w.hostUrl + "/user-url/?user_id=" + e.user_id + "');\"" : "") + ' title="' + p(e.name) + '">' + n + "</a>" : n
        },
        ...
        var t = [];
        for (var n in e)
            t.push('<input type="hidden" name="' + n + '" value="' + p(e[n]) + '" />');
        return t.join("\n")
    };
    for (; U < R.length; U++)
        w[R[U]] = function(e) {
    ...
    }), tt = w.events = new Z, nt = w.site = new et, rt = w.visitor = new et, it = w.unread = new et, st = w.threads = {}, ot = w.postPool = {}, ut = w.users = {};
    tt.on("queryDefined", function() {
        ...
        function vt(e, t) {
            ...
            this.delegate("a.ds-post-likes", "click", function(e) {
                ...
                var t = i(this).closest(".ds-post-self"), n = ot[t.attr("data-post-id")];
                ...
                var n = i(this).closest(".ds-post-self"), r = ot[n.attr("data-post-id")], s = r.data.source;
                if (!rt.data.social_uid[s == "qqt" ? "qq": s]) {
                    mt(s);
                    return 
                }
                var o = r.data.root_id, u = o != "0" ? ot[o]: r, a = "";
                if (o != "0") {
                    var f = K(r.data);
                    ...
                    Y = setTimeout(function() {
                        ...
                        try {
                            if (r.hasClass("ds-comment-context"))
                                G.attr("id", "ds-ctx-bubble").attr("data-post-id", r.attr("data-post-id")).html('<ul id="ds-ctx">' + J.ctxPost(ot[r.attr("data-parent-id")].data) + "</ul>" + '<div class="ds-bubble-footer"><a class="ds-ctx-open" href="javascript:void(0);">\u67e5\u770b\u5bf9\u8bdd</a></div>');
        ...
        function mt(e) {
            ...
            x.authInWin && O(e, t) || (r.href = parseURL(t))
        }
        function gt() {
        ...
        function bt(e) {
            ...
            for (var r in n)
                n[r] && (!S || encodeURIComponent(n[r]).length < 200) && (e[r] = n[r]);
            return e
        }
        var i = w.jQuery, s = i(e), a = i(t), l = w.loadRequire = function(e) {
        ...
        if (e.postMessage) {
            var F = function(e) {
                if (e.origin === "http://duoshuo.com")
                    switch (e.data.type) {
                    case"login":
                        r.href = parseURL(e.data.redirectUrl);
                        break;
                    default:
                    }
            };
        ...
        var R = w.Widget = Z.extend({
            ...
            [e], n = j("<h2>" + t.title + "</h2>" + '<ul class="ds-unread-list"></ul>');
        ...
        w.resetNotify = function() {
            ...
            var n = e.options, r = rt.data, i = [], s = "", o, u = {
                thread_id: e.threadId,
                parent_id: "",
                nonce: w.nonce
            };
            for (var a in r.repostOptions)
                r.repostOptions[a] && (i.push(a), o = 1), s += J.serviceIcon(a, !r.repostOptions[a]);
            ...
            render: function(e) {
                ...
                var n = this, r = n.embedThread, s = r.options, u = function(e) {
                ...
                }, a = n.el = i(J.replybox(r, e)).click(u), f = a.find("form"), l = f.find("input[type=checkbox]")[0], c = f.find("a.ds-service-icon, a.ds-service-icon-grey"), h = B(f.find("textarea")).focus(u).keyup(g).keyup(y).bind("focus mousedown mouseup keyup", m), d = a.find(".ds-add-emote").click(function(e) {
                    ...
                    return d.toggleClass("ds-expanded").hasClass("ds-expanded") ? (r || (r = w.smiliesTooltip = new H.SmiliesTooltip, r.render(), w.require("smilies", function() {
                        ...
                        top : n.el.offset().top + n.el.outerHeight() + 4 + "px", left: n.el.find(".ds-textarea-wrapper").offset().left + "px"
                ...
                b = a.find(".ds-add-image").click(function(e) {
                    ...
                    s = '<img src="' + i + '" />';
                    if (t.selection) {
                        n.value = r.substring(0,
                        v.start) + s + r.substring(v.end,
                        r.length),
            ...
            for (var r in t)
                n.push('<li><a class="ds-share-to-' + r + " ds-service-link ds-" + r + '" href="' + w.hostUrl + "/share-proxy/?" + w.param({
                    service: r,
                ...
                var r = this, s = r.embedThread, o = s.data, u = r.el = i('<div class="ds-meta"><a href="javascript:void(0)" class="ds-like-thread-button ds-rounded' + (o.user_vote > 0 ? " ds-thread-liked" : "") + '"><span class="ds-icon ds-icon-heart"></span>' + ' <span class="ds-thread-like-text">' + (o.user_vote > 0 ? "\u5df2\u559c\u6b22" : "\u559c\u6b22") + '</span><span class="ds-thread-cancel-like">\u53d6\u6d88\u559c\u6b22</span></a><span class="ds-like-panel"></span></div>'), a = u.find(".ds-like-thread-button").click(function(f) {
                    ...
                    return l ? r.tooltip && c(f) : (r.tooltip === n && (r.tooltip = i(J.likeTooltip(o)).click(h).delegate("a", "click", function(t) {
                        ...
                        case"ds-like-tooltip-close":
                            ...
                            break;
                        default:
                            if (!e.open(this.href, "_blank", "height=500,width=600,top=0,left=0,toolbar=no,menubar=no,resizable=yes,location=yes,status=no", "gl"))
                                return 
                        }
                        return !1
            ...
            render: function() {
                var e = this.embedThread, t = e.options, n = e.postList, r = this.el = i(J.postListHead(e)), s = r.find("ul.ds-comments-tabs").delegate(".ds-tab a", "click", function(t) {
            ...
            render: function() {
                var e = this, n = e.el = i(J.smiliesTooltip(q));
            ...
            var n = K(e), r = n.user_id ? ' data-user-id="' + n.user_id + '"': "", s = n.qqt_account || "", o = J.timeHtml(e.created_at, e.url), u = e.parents || [];
            switch (e.source) {
            case"duoshuo":
            ...
            return '<li class="ds-post" data-post-id="' + e.post_id + '"><div class="ds-post-self" data-post-id="' + e.post_id + '" data-thread-id="' + e.thread_id + '" data-root-id="' + e.root_id + '" data-source="' + e.source + '"><div class="ds-avatar"' + r + ">" + J.avatar(n) + (w.sourceName[e.source] ? J.serviceIcon(e.source) : "") + '</div><div class="ds-comment-body"><div class="ds-comment-header">' + (n.url ? '<a class="ds-user-name ds-highlight" data-qqt-account="' + s + '" href="' + p(n.url) + '" ' + (n.user_id ? " onclick=\"this.href=parseURL('" + w.hostUrl + "/user-url/?user_id=" + n.user_id + "');\"" : "") + ' rel="nofollow" target="_blank"' + r + ">" + p(n.name) + "</a>" : '<span class="ds-user-name"' + r + ' data-qqt-account="' + s + '">' + p(n.name) + "</span>") + "</div>" + (t.max_depth == 1 && t.show_context && u.length ? '<ol id="ds-ctx">' + i.map(u, function(e, t) {
        ...
        var $ = i('<div id="ds-bubble"><div class="ds-bubble-content"></div><div class="ds-arrow ds-arrow-down ds-arrow-border"></div><div class="ds-arrow ds-arrow-down"></div></div>'), G = $.find(".ds-bubble-content").delegate("a.ds-ctx-open", "click", function(e) {
        ...
        }), Y = bubbleOutTimer = 0, tt = function() {
        ...
        bubbleOut = function() {
            ...
            refetch: function() {
                var e = this, n = i(J.indicator()).appendTo(t.body).fadeIn(200);
            ...
            render: function() {
                var e = this.el.attr("id", "ds-thread").append(J.waitingImg()), t = e.width(), n = e.data("url") ||!e.attr("data-thread-id") && i("link[rel=canonical]").attr("href");
            ...
            onload: function(t) {
                var r = this, s = r.threadId = t.thread.thread_id, u = t.cursor, a = r.options = t.options, f = r.innerEl = _(i('<div id="ds-reset"></div>').appendTo(r.el));
                ...
                var l = r.replybox = new H.Replybox(r), c = l.render().el.find("textarea");
                ...
                if (ct()) {
                    ...
                    r.toolbar = i(J.toolbar()).delegate(".ds-account-control", "mouseenter", function() {
        ...
        w.initSelector = function(e, t) {
            ...
            setInterval(function() {
                i(".ds-time").each(function() {
                    ...
                    e && (this.innerHTML = parseHTML(w.elapsedTime(e)))
                })
